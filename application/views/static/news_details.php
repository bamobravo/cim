 <?php include "includes/header_home.php" ?>
        ...
        <div id="content">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                    <div class="article-title"><?php echo $news['title'] ?></div>
                    <div class="authname"><span><?php echo $news['author'] ?></span> <span><?php echo formatReadable($news['date']) ?></span></div>
                    <div class="main-text"><?php echo $news['news_content'] ?></div>
